...
const MessagesPage = () => {
  ...
  return (
    <div className='min-h-screen relative bg-slate-50 z-4'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='flex flex-col gap-3'>
            {dummyConnectionsData.map((user)=>(
              <div key={user._id} className='max-w-xl  flex  flex-wrap md:flex-nowrap   gap-5 p-6 bg-white shadow rounded-md'>
