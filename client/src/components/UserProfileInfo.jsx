    ...
    <div className="relative py-4 px-6 md:px-8 bg-white">
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex items-center gap-6 mt-6 border-t border-gray-200 pt-4">
            <div>
                <span className="sm:text-2xl font-bold text-gray-900">{posts.length}</span>
                <span className="text-sm sm:text-sm  text-gray-500 ml-1.5">Posts</span>
            </div>
            <div>
                <span className="sm:text-2xl font-bold text-gray-900">{user.followers.length}</span>
                <span className="text-sm sm:text-sm  text-gray-500 ml-1.5">Followers</span>
            </div>
            <div>
                <span className="sm:text-2xl font-bold text-gray-900">{user.following.length}</span>
                <span className="text-sm sm:text-sm  text-gray-500 ml-1.5">Follwoing</span>
            </div>
        </div>
        </div>
      </div>
